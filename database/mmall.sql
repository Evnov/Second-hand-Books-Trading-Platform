...
CREATE TABLE `mmall_product` (
  ...
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `book_condition` decimal(2,1) NOT NULL,
  PRIMARY KEY (`id`),
